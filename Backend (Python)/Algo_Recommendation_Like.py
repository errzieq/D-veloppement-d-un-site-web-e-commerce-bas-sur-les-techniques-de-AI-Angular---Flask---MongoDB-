...
for line in tab[["userIdnew","produitIdnew","like"]].itertuples():#parcourir la ligne col par col
...
# I = Indice si un produit aimé par un utilisateur (1: oui , 0: non)
I = data_matrix.copy()
I[I > 0] = 1
I[I == 0] = 0
...
resultat.to_csv(r'C:/Users/errza/OneDrive/Bureau/PFE_FILES_FIN/ALSLikes.csv')